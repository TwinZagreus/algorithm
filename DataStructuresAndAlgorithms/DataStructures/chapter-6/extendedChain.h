...
template <typename T>
class extendedChain :
    public extendedLinearList<T>, public chain<T>
{
...
template<typename T>
inline void extendedChain<T>::erase(int theIndex)
{
...
template<typename T>
inline void extendedChain<T>::insert(int theIndex, const T& theElement)
{
...
template<typename T>
inline void extendedChain<T>::push_back(const T& theElement)
{
