...
#### 2.4.4 [leetcode1011.在 D 天内送达包裹的能力](https://leetcode.cn/problems/capacity-to-ship-packages-within-d-days/)
...
#### 2.6.2 [leetcode83.删除有序链表中的重复元素](https://leetcode.cn/problems/remove-duplicates-from-sorted-list/)
...
#### 2.6.3 [leetcode27.移除元素](https://leetcode.cn/problems/remove-element/)
...
#### 2.6.4 [leetcode283.移动零](https://leetcode.cn/problems/move-zeroes/)
...
#### 2.7.1 [leetcode21.合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)
...
public class Solution {
    public ListNode MergeTwoLists(ListNode list1, ListNode list2) {
      ListNode resres = new ListNode();
      resres.val = -101;
      ListNode cur = resres;
      while(list1!=null&&list2!=null){
        if(list1.val<=list2.val){
          ListNode newnew  = new ListNode() ;
          newnew.val = list1.val;
          cur.next = newnew;
          cur = cur.next;
          list1 = list1.next;
        }else{
          ListNode newnew  = new ListNode();
          newnew.val = list2.val;
          cur.next = newnew;
          cur = cur.next;
          list2 = list2.next;
        }
...
#### 2.7.2 [leetcode23.合并 k 个有序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)

==用分治法去调用 MergeTwoLists，降低时间复杂度==
...
#### 2.7.3 [leetcode141.环形链表](https://leetcode.cn/problems/linked-list-cycle/description/)
...
#### 2.7.4 [leetcode142.环形链表 2](https://leetcode.cn/problems/linked-list-cycle-ii/description/)
...
public class Solution {
  public ListNode DetectCycle(ListNode head) {
    ...
    while(fast!=null&&fast.next!=null){
      ...
      fast = fast.next.next;
      if(fast==slow){
        ListNode forTime = head;
        while(slow!=forTime){
          slow=slow.next;
          forTime = forTime.next;
        }
        RES = slow;
        break;
      }
...
```
#### 2.7.5 [leetcode876.链表的中间结点](https://leetcode.cn/problems/middle-of-the-linked-list/description/)
...
#### 2.7.6 [leetcode19.删除链表的倒数第 n 个结点](https://leetcode.cn/problems/remove-nth-node-from-end-of-list/)
...
```
#### 2.7.7 [leetcode160.相交链表](https://leetcode.cn/problems/intersection-of-two-linked-lists/)
...
```
### 2.8 链表递归
#### 2.8.1 [leetcode206.反转链表](https://leetcode.cn/problems/reverse-linked-list/description/)

```cs


```
#### 2.8.2 [leetcode92.反转链表2](https://leetcode.cn/problems/reverse-linked-list-ii/description/)
...
# 排序算法 [排序数组](https://leetcode.cn/problems/sort-an-array/)
...
public class Solution {
  ...
  private void QuickSort(int[] nums,int start,int end){
    if(start<end){
      int pivotIndex = handle(nums,start,end);
      QuickSort(nums,start,pivotIndex-1);
      QuickSort(nums,pivotIndex+1,end);
    }
  }

  private int handle(int[] nums,int start,int end){
    int randomValue = random.Next(start, end);
    swap(nums,start,randomValue);
